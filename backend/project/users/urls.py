from .views import CompanyViewset, RegisterCompanyView, RegisterCustomerView, MyTokenObtainPairView, SchedulingViewSet
...
urlpatterns = [
    ...
    path('auth/scheduling', SchedulingViewSet.as_view()),
